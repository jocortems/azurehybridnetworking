...
>[!NOTE]
Azure documentation mentions 1Gbps (see [here](https://docs.microsoft.com/azure/virtual-wan/virtual-wan-about#what-is-the-total-vpn-throughput-of-a-vpn-tunnel-and-a-connection) and [here](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpn-gateway-settings#benchmark)) in practice it is possible to achieve up to 1.25Gbps
